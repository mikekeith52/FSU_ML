...
- many_shooting_events: 1 if the state had many shooting events in the given year/month (I chose an arbitrary cutoff around the 25 percentile of the rate of shootings per capita for all states in all months), 0 otherwise. **Dependent Variable**
